        ...
        <form action="index.php?">
            ...
            <td class="col">
                <select class="form-control" id="status" name="field_cc_id">
                    ...
                    <option value="Статус1">Статус1</option>
                    <option value="Статус2">Статус2</option>
                    <option value="Статус3">Статус3</option>
                    <option value="Статус4">Статус4</option>
                    <option value="Статус5">Статус5</option>
                </select>
            </td>
